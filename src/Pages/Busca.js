...
export default function Busca() {
    ...
    {
        await fetch('http://10.139.75.41:5251/api/Clients/GetAllClients', {
            method: 'GET',
            headers: {
    ...
    {    
      await fetch('http://10.139.75.41:5251/api/Clients/GetClientId/' + id,{
              method: 'GET',
              headers: {
  ...
  async function deleteClient(id, clientName) {
    await fetch('http://10.139.75.41:5251/api/Clients/DeleteClient/' + id,{
            method: 'DELETE',
            headers: {
                'Content-type' : 'application/json; charset=UTF-8',
            },
